# [Write-up] PortSwigger: Web cache poisoning via ambiguous requests

> - **Phân loại lỗ hổng:** HTTP Host Header Attacks / Web Cache Poisoning
> - **Độ khó bài Lab:** Practitioner (PortSwigger Web Security Academy)
...
## 2. Mô hình tấn công (Data Flow & Root Cause)
...
## 3. Khai thác lỗ hổng (Exploitation Walkthrough)
